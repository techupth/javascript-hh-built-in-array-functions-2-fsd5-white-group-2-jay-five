...
// Start coding here
function fineTotalOnLocation(bill) {
  return bill.reduce((accumulator, currentValue) => {
    let { location, total } = currentValue;
    if (location in accumulator) {
...
const totalPaidByLocation = fineTotalOnLocation(bills);
